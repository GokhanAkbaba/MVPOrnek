...
public class ImagePickerActivity extends Activity {
    ...
    public static void showImagePickerOptions(Context context, final PickerOptionListener listener) {
        ...
        builder.setTitle(context.getString(R.string.profil_fotografi_sec_txt));

        // add a list
        String[] animals = {context.getString(R.string.fotograf_cek_txt), context.getString(R.string.galeriden_sec_txt)};
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.areAllPermissionsGranted()) {
                            ...
                            System.out.println("FotoğrafADI"+fileName);
